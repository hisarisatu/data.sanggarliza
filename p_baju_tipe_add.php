...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_tipe_baju, keterangan, harga from p_baju_tipe where id_tipe_baju='$id'";
        //echo $runSQL;
...
if (strlen($run) > 1){ 
	...
	if (($ok == 1) and ($id == "")){
		$registerInvalid = 1;
		$runSQL = "insert into p_baju_tipe VALUES (null,'$keterangan','$harga')";
		//echo $runSQL;
		$insert = mysql_query($runSQL, $connDB);
		$id = mysql_insert_id($connDB);
	} else if (($ok == 1) and ($id <> "")){
		$registerInvalid = 1;
		$runSQL = "update p_baju_tipe set keterangan='$keterangan', harga='$harga' where id_tipe_baju='$id'";
		//echo $runSQL;
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Tipe Baju</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <a href="<?="?menu=$menu&uid=$uid&page=p_baju_tipe";?>"><b>List Tipe Baju</b></a>
		 </td>
	  </tr>
	...
	<tr>
			<td width="35%" align="right">Detail Tipe Baju</td>
        ...
        <tr>
            ...
            <td width="65%"><input name="harga" cols="50" rows="2"><?=htmlentities(stripslashes($harga));?></textarea> <font color="#FF0000"><b>*</b></font> <?=$iharga;?></td>
        </tr>
<tr>
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Tipe Baju</b><br></font>
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
        <tr valign=top>
         ...
         <tr valign=top>
            <td width="35%" align="right">Harga : </td>
            <td width="65%"><font class="datafield"><?=$harga?></font></td>
        </tr>
	 </table>
	 ...
	 <p>&nbsp;</p>
	 <img src="images/arrow2.gif" border="0">
	 <a href="<?="?menu=$menu&uid=$uid&page=p_baju_tipe";?>"><b>List Jenis Baju</b></a>
   </td>
  </tr>
  </form>
</table>
