  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_acc_detail";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_acc_add";?>">Tambah</a>| <a href="<?="?menu=$menu&uid=$uid&page=p_acc_tipe";?>">Tambah Katagori</a></b>
		 </td>
		 </form>
	  </tr>
