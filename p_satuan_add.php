...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_satuan, keterangan from p_satuan where id_satuan='$id'";
        //echo $runSQL;
...
if (strlen($run) > 1){ 
	...
	if (($ok == 1) and ($id == "")){
		$registerInvalid = 1;
		$runSQL = "insert into p_satuan VALUES (null,'$keterangan')";
		//echo $runSQL;
		$insert = mysql_query($runSQL, $connDB);
		$id = mysql_insert_id($connDB);
	} else if (($ok == 1) and ($id <> "")){
		$registerInvalid = 1;
		$runSQL = "update p_satuan set keterangan='$keterangan' where id_satuan='$id'";
		//echo $runSQL;
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <td valign="bottom" align="right">
			 ...
			 <a href="<?="?menu=$menu&uid=$uid&page=p_satuan";?>"><b>List Satuan</b></a>
		 </td>
	  </tr>
	...
	<tr>
			<td width="35%" align="right">Detail Satuan</td>
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Satuan</b><br></font>
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
        <tr valign=top>
            <td width="35%" align="right">Satuan : </td>
