...
(SELECT distinct a.nama_cpw, a.nama_cpp, max(b.tanggal) as tanggal, b.isi, c.nama, c.id_pegawai from client a, konsultasi b, pegawai c where b.id_client=a.id_client and b.petugas=c.id_pegawai $filterSQL group by b.id_client ) b ";
...
$runSQL = "	SELECT a.nama_cpw, a.nama_cpp, max(b.tanggal) as tanggal, b.isi, c.nama, c.id_pegawai from client a, konsultasi b, pegawai c where b.id_client=a.id_client and b.petugas=c.id_pegawai $filterSQL
