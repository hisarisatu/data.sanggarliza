...
<table border="0" cellspacing='8' cellpadding='5' align=left>
...
for($n1=0;$n1<mysql_num_rows($res);$n1++){
 ...
 echo "<tr><td colspan=11 style='border-width: 1px; border-style: outset;'><b>Acara : ";
 ...
 $rp=mysql_query("select id_baju, id_sepatu, id_acc, id_blangkon, id_kain from client_busana where id_client='$id_client' 
...
$np=mysql_query("select  b.layanan as baju, c.jml_baju, d.layanan as sepatu, e.layanan as acc, c.jml_sepatu, c.jml_acc,  f.layanan as kain , c.jml_kain, g.layanan as blangkon, c.jml_blangkon from  p_baju b, client_busana c, p_sepatu d, p_acc e, v_kain f, v_blangkon g where  b.id_layanan='$id_baju' and d.id_layanan='$id_sepatu' and e.id_layanan='$id_acc' and f.id_layanan='$id_kain' and g.id_layanan='$id_blangkon' and c.id_client='$id_client'
				");
