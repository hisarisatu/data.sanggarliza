...
p_baju_tipe h,p_baju i,p_baju_tipe j,p_baju k
...
c.nama_cpw,c.nama_cpp,e.detail_layanan,h.keterangan tipe_baju,i.layanan jns_baju,g.jml_baju,i.qty kap_baju,
j.keterangan tipe_kain,k.layanan jns_kain,g.jml_kain,k.qty kap_kain
...
<?
js_submit();
$sqlbaju="select distinct id_layanan,layanan from p_baju where id_tipe_baju like '$id_tipe_baju' union select '0','--Pilih Jenis Baju--' from dual";
...
<?
js_submit();
$sqlkain="select distinct id_layanan,layanan from p_baju where id_tipe_baju like '$id_tipe_kain' union select '0','--Pilih Jenis Kain--' from dual";
