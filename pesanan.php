...
{
$htmlData .= "<td align='center' nowrap><a href='?menu=$menu&uid=$uid&page=client_konsultasi&id_client=$row[id_client]'><img border='0' src='images/note.gif' height=16 width=16 title='Konsultasi'></a></td>";
} else { }
