...
if($act=="add_noextra_proses"){
	...
	{
        $harga=($harga_bebas*$jml_layanan);
        $sql="insert into pesanan_bebas(id_client,id_acara,id_sublayanan,detail_layanan,jml_orang,harga,satuan) values('$id_client','$id_acara','$id_layanan','$layanan_bebas','$jml_layanan','$harga','$id_satuan')";
