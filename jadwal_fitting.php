...
$htmlData .= "<td align='center' nowrap>
		  <a href='?menu=$menu&uid=$uid&page=jadwal_fitting_lihat&id=$row[id_client]'><img border='0' src='images/view.png' title='Lihat Data'></a>";
if($SAH[id_group]==1 || $SAH[id_group]==7 ||  $SAH[id_group]==8){
$htmlData .= "</td><td align='center' nowrap>";
$htmlData .= "
		  <a href='?menu=$menu&uid=$uid&page=jadwal_fitting_input&id=$row[id_client]'><img border='0' src='images/edit.gif' title='Edit Data'></a>		  
";
}
$htmlData .= "</td>
</tr>";
