...
if (($SAH[id_group]==3) or ($SAH[id_group]==1) or ($SAH[id_group]==5) or ($SAH[id_group]==12))
{
   ...
   <td width="100%" align="center" vAlign="top">
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
		...
		<tr>
			...
			<td width="65%"><input type="text" name="id_client" size="40" value="<?=htmlentities(stripslashes($id_client));?>" disabled > <font color="#FF0000"><b>*</b></font> <?=$iid_client;?></td>
		</tr>
        
        <tr>
			<td width="35%" align="right">Nama Lengkap CPW</td>
			<td width="65%"><input type="text" name="nama_cpw" size="40" value="<?=htmlentities(stripslashes($nama_cpw));?>" disabled > <font color="#FF0000"><b>*</b></font> <?=$inama_cpw;?></td>
		</tr>
		<tr>
			<td width="35%" align="right">Nama Orang Tua CPW</td>
			<td width="65%"><input type="text" name="nama_ortu_cpw" size="40" value="<?=htmlentities(stripslashes($nama_ortu_cpw));?>"disabled ></td>
		</tr>
		<tr>
			<td width="35%" align="right">Telepon Rumah CPW</td>
			<td width="65%"><input type="text" name="tlp_rumah_cpw" size="20" value="<?=htmlentities(stripslashes($tlp_rumah_cpw));?>" disabled > <font color="#FF0000"><b>*</b></font> <?=$itlp_rumah_cpw;?></td>
		</tr>
		<tr>
			<td width="35%" align="right">Nomor HP CPW</td>
			<td width="65%"><input type="text" name="tlp_mobile_cpw" size="20" value="<?=htmlentities(stripslashes($tlp_mobile_cpw));?>" disabled > <font color="#FF0000"><b>*</b></font> <?=$itlp_mobile_cpw;?></td>
		</tr>
		<tr>
			<td width="35%" align="right">Alamat CPW</td>
			<td width="65%">
            <textarea rows=3 cols=50 name="konsultasi" disabled><?=htmlentities(stripslashes($alamat_cpw));?></textarea> <font color="#FF0000"><b>*</b></font> <?=$ialamat_cpw;?></td>
		</tr>
		...
		<tr>
			...
			<td width="65%"><input type="text" name="nama_cpp" size="40" value="<?=htmlentities(stripslashes($nama_cpp));?>" disabled > <?=$inama_cpp;?></td>
		</tr>
		<tr>
			<td width="35%" align="right">Nama Orang Tua CPP</td>
			<td width="65%"><input type="text" name="nama_ortu_cpp" size="40" value="<?=htmlentities(stripslashes($nama_ortu_cpp));?>"disabled ></td>
		</tr>
		<tr>
			<td width="35%" align="right">Telepon Rumah CPP</td>
			<td width="65%"><input type="text" name="tlp_rumah_cpp" size="20" value="<?=htmlentities(stripslashes($tlp_rumah_cpp));?>"disabled ></td>
		</tr>
		<tr>
			<td width="35%" align="right">Nomor HP CPP</td>
			<td width="65%"><input type="text" name="tlp_mobile_cpp" size="20" value="<?=htmlentities(stripslashes($tlp_mobile_cpp));?>"disabled ></td>
		</tr>
		<tr>
			<td width="35%" align="right">Alamat CPP</td>
			<td width="65%"><textarea rows=3 cols=50 name="konsultasi" disabled><?=htmlentities(stripslashes($alamat_cpp));?></textarea></td>
		</tr><tr>
			<td width="35%" align="right"> Tanggal </td><td> <input type='text' name='tgl_rencana' size='11' value='<?=$new_tanggal?>'disabled >
		...
		<tr>
			...
			<td width="65%"><input type="text" name="catatan" size="55" value="<?=htmlentities(stripslashes($catatan));?>"disabled ></td>
		</tr>
		<tr>
			<td width="35%" align="right">Email CPW/CPP</td>
			<td width="65%"><input type="text" name="email" size="40" value="<?=htmlentities(stripslashes($email));?>"disabled > <font color="#FF0000"><b>*</b></font> <?=$iemail;?></td>
		</tr>
		<tr>
			<td width="35%" align="right">Facebook</td>
			<td width="65%"><input type="text" name="facebook" size="40" value="<?=htmlentities(stripslashes($facebook));?>"disabled ></td>
		</tr>
		<tr>
			<td width="35%" align="right">Twiter</td>
			<td width="65%"><input type="text" name="twiter" size="40" value="<?=htmlentities(stripslashes($twiter));?>"disabled ></td>
		</tr>
		<tr>
