...
Select b.id_non_client, concat('-----','-')tgl_acara,  b.nama  as nama,  DATE_FORMAT(b.tanggal, '%d-%m-%Y')tgl_bayar, b.detail as keterangan, 
CONCAT ( c.keterangan ,'-', d.keterangan  ) as catatan , concat ('-' , b.nama, '-') pembayar ,b.jumlah, b.kwitansi
from non_client b, p_pengeluaran a ,p_pembayaran c ,p_bank d 
where b.divisi=a.id_jenis_bagian and b.jenis_bayar=c.id_jenis_bayar and b.bank=d.id_bank   $filterSQL ";
//echo $runSQL;
?>
...
<a href="print_r_masuk_lengkap.php?tanggal=<?=$tanggal?>&tanggal2=<?=$tanggal2?>" target="_blank"><img border="0" src="images/Printer.png" height="25" width="25" alt="Print to Excel" title="Cetak pemasukan" /></a>
&nbsp;&nbsp;&nbsp;
