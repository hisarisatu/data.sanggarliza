...
unset($ii);
$runSQL = "select id_pegawai, nama, tlp_rumah, tlp_mobile, alamat, catatan, atm,bank from pegawai $filterSQL order by id_pegawai desc LIMIT $offsetRecord, $listRecord";
$result = mysql_query($runSQL, $connDB);
