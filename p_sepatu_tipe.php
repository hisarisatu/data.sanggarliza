...
$runSQL = "select count(*) total from p_sepatu_tipe where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select id_tipe_sepatu,keterangan from p_sepatu_tipe $filterSQL order by id_tipe_sepatu LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
while ($row = mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=p_sepatu_tipe_add&id=$row[id_tipe_sepatu]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Tipe Sepatu</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_sepatu_tipe";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_sepatu_tipe_add";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
	 ...
	 <table width='700' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			...
			<td align='center'>Jenis Sepatu</td>
