...
<a href="javascript:void(window.open('print_backroom_wanita_standar.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
$np=mysql_query("select nama,  nama_jabatan
				...
				where id_client='$id_client' and  id_acara='$id_acara' and  id_sublayanan='$id_plus' and jenis_rias=1 order by nama_jabatan");
