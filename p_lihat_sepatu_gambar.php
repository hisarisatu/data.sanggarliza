...
if($_GET['id_param']!=''){
    $sql_delete="delete from p_sepatu where id_layanan ='".$_GET['id_param']."'";
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
				   ...
				   <td align=center> $row[layanan] </td>
				    <td align=center><img src='gambar2/$row[gambar]'border='0'/> </td>
...
<table  border="0" width="819" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Gambar Baju</b></font>
	 ...
	 <table width='781' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25" align="center">
                        ...
                        <td width="221" >Nama Sepatu</td>
						<td width="543" >Gambar</td>
