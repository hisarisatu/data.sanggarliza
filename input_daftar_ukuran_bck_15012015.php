...
<tr><td>Ukuran Beskap </td><td>:	<?
			...
			union select 31,'--Pilih Ukuran Beskap--' from dual";
...
<tr><td>Ukuran Blangkon </td><td>:	<?
			...
			union select 31,'-Pilih Ukuran Blangkon-' from dual";
...
<tr><td>Ukuran Selop </td><td>:	<?
			...
			union select 31,'--Pilih Ukuran Selop---' from dual";
...
when ukuran_beskap = 31 then 'All'
...
when ukuran_blangkon = 31 then 'All'
