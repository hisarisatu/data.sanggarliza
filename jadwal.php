...
$runSQL = "select count(*) total from (Select id_jadwal, tanggal, jam, acara, jadwal
from jadwal
...
from jadwal
where 1=1 $filterSQL 
order by tanggal asc, jam asc  LIMIT $offsetRecord, $listRecord";
//echo $runSQL;
$result = mysql_query($runSQL, $connDB);
while ($row = mysql_fetch_array ($result)) {
	$ccc++;
...
$htmlData .= "
		  <a href='?menu=$menu&uid=$uid&page=jadwal_input&id=$row[id_jadwal]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Jadwal</b></font>

	 <table width="100%" border="0" cellpadding="5" cellspacing="0">
	  <tr>
		 <form method="POST" name="form" action="<?="?menu=$menu&uid=$uid&page=$page";?>">
     <td width="65%" valign="bottom"><b>Tanggal Acara ::
       <input type='text' name='tanggal' id="tanggal" size='11' value='<?=$tanggal?>'>
		...
		<input type='text' name='tanggal2' id="tanggal2" size='11' value='<?=$tanggal2?>'>
           ...
           <td width="25%" align="right" valign="bottom">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=jadwal_input";?>">Input Baru</a> <!--| <a href="<?//= "?menu=$menu&uid=$uid&page=client&act=cari";?>">Cari</a>--></b>
		 </td>
     <td width="10%" align="right" valign="bottom">
			 <img src="images/arrow2.gif" border="0">
			 <b><a href="<?="?menu=$menu&uid=$uid&page=jadwal";?>">List All</a> <!--| <a href="<?//= "?menu=$menu&uid=$uid&page=client&act=cari";?>">Cari</a>--></b>
		 </td>
    ...
    //]]></script>-->
	 ...
	 <table width='99%' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			...
			<td width="7%" align='center'>JAM</td>
            <td width="35%" align='center'>ACARA</td>
            <td width="50%" align='center'>JADWAL</td>
