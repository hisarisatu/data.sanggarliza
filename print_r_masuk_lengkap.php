...
and a.id_client=b.id_client and b.tanggal  BETWEEN '$tanggal' AND '$tanggal2' and b.catatan like '%$catatan%' 
...
where b.divisi=a.id_jenis_bagian and b.tanggal BETWEEN '$tanggal' AND '$tanggal2' and b.catatan like '%$catatan%' group by b.id_non_client 
...
and a.id_siswa=b.id_siswa and b.tanggal  BETWEEN '$tanggal' AND '$tanggal2' and b.catatan like '%$catatan%'
";
//echo $runSQL;
?>
