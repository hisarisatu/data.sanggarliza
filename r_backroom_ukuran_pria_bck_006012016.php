...
$htmlData .="<td align='center' nowrap><a href='?menu=$menu&uid=$uid&page=view_ukuran_fiting_pria&id=$row[id_client]'><img border='0' src='images/view.png' title='Lihat Data'></a></td>";

$htmlData .="<td align='center' nowrap><a href='?menu=$menu&uid=$uid&page=view_ukuran_fiting_rekap_pria&id=$row[id_client]'><img border='0' src='images/view.png' title='Lihat Data'></a></td>";
$htmlData .="<td align='center' nowrap><a href='?menu=$menu&uid=$uid&page=view_no_tas_pria&id=$row[id_client]'><img border='0' src='images/view.png' title='Lihat Data'></a></td>";
...
?>
	 ...
	 <table width='100%' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
            ...
            <td align='center'>Nama &amp;<br>Busana</td>
            <td align='center'>Rekap Ukuran</td>
            <td align='center'>No Tas</td>
		</tr>
		<?=$htmlData;?>
		<tr>
		  <td colspan="12" align="left">
