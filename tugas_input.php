...
//if (strlen($id_pegawai) < 1){ $iid_pegawai = "<br><font color='#FF0000' size='1'><i>* Petugas CS tidak valid"; $ok=0; }
		...
		$registerInvalid = 1;
		$runSQL = "update tugas set nama='$nama', detail='$detail', tanggal='$new_tanggal', progres='$progres' where id_tugas='$id'";
		//echo $runSQL;
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
		...
		<tr>
			...
			<td width="65%"><textarea name="detail" cols="50" rows="5" ><?=$detail;?></textarea> <font color="#FF0000"><b>*</b></font> <?=$idetail;?></td>
				...
				<tr>
			<td width="100%" align="right">Dateline</td><td> <input type='text' name='tanggal' size='11' value='<?=$new_tanggal?>'>
