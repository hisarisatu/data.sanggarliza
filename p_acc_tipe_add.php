...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_tipe_acc, keterangan from p_acc_tipe where id_tipe_acc='$id'";
        //echo $runSQL;
...
if (strlen($run) > 1){ 
	...
	if (($ok == 1) and ($id == "")){
		$registerInvalid = 1;
		$runSQL = "insert into p_acc_tipe VALUES (null,'$keterangan')";
		//echo $runSQL;
		$insert = mysql_query($runSQL, $connDB);
		$id = mysql_insert_id($connDB);
	} else if (($ok == 1) and ($id <> "")){
		$registerInvalid = 1;
		$runSQL = "update p_acc_tipe set keterangan='$keterangan' where id_tipe_acc='$id'";
		//echo $runSQL;
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Tipe Accecoris</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <a href="<?="?menu=$menu&uid=$uid&page=p_acc_tipe";?>"><b>List Tipe Accecoris</b></a>
		 </td>
	  </tr>
	...
	<tr>
			<td width="35%" align="right">Detail Tipe Accecoris</td>
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Tipe acc</b><br></font>
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
        <tr valign=top>
            <td width="35%" align="right">Jenis acc : </td>
	 ...
	 <p>&nbsp;</p>
	 <img src="images/arrow2.gif" border="0">
	 <a href="<?="?menu=$menu&uid=$uid&page=p_acc_tipe";?>"><b>List Jenis acc</b></a>
   </td>
  </tr>
  </form>
</table>
