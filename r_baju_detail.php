...
<td> $row[kode] </td>
                  ...
                  <td align=center> $row[daerah] </td>
				   ...
				   <td align='center' nowrap>
					  ...
					  <td align='center' nowrap>
					  <a href=\"javascript:void(window.open('p_lihat_baju_gambar.php?id=$row[id_layanan]','operator','toolbar=0,width=900,height=500,top=0, left=60'));\"><img border='0' src='images/view.png'></a>
   ...
   <td width="100%" align="center" vAlign="top">
     ...
     <td valign="bottom" align="left">
		<img src="images/arrow2.gif" border="0">
			 <b><a href="<?="?menu=$menu&uid=$uid&page=r_baju_detail";?>">List All</a></b>
		 </td>
		 </form>
	  </tr>
