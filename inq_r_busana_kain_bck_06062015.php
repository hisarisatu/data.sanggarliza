...
$pageFilter ="&tanggal=$tanggal&tanggal2=$tanggal2&id_tipe_baju=$id_tipe_baju&id_baju=$id_baju&id_tipe_kain=$id_tipe_kain&id_kain=$id_kain";
				...
				if($tanggal !="" && tanggal2 !="") {$filterSQL .= " and a.tanggal BETWEEN '$tanggal' AND '$tanggal2' ";}
...
c.nama_cpw,c.nama_cpp,e.detail_layanan,j.keterangan tipe_kain,k.layanan jns_kain,g.jml_kain
