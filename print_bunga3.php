...
?>
     ...
     <td width="50%" valign="bottom" align="left"> &nbsp; 
	     <font class="titledata" color="#000000" size="5"><b>Rincian Pesanan Bunga</b></font>
	    </td>
...
$res = mysql_query($sql);
 ...
 echo "<tr><td colspan=2 style='border-width: 1px; border-style: outset;'><font size='5'><b>Acara : ";
...
echo $no.". ";
		...
		echo "</tr><tr><td nowrap><font size='5'>";
...
if($jpp!=0) 
echo "<tr><td colspan=2><font size='5'><b>Tambahan</td></tr>";
for($p=0;$p<$jpp;$p++){
	echo "<font size='5'>";
...
echo "</font><tr><td colspan=2>&nbsp;</td></tr>";
