	...
	<table border="1" cellpadding="5" cellspacing="0" width="1000">
		...
		<tr><td width="25%" align="left">Update Baju</td>
			...
			<?
				...
				where (upper(keterangan) not like '%KAIN%' and upper(keterangan) not like '%BLANGKON%') order by keterangan asc";
				$rs=mysql_query($sql);
		...
		<tr><td width="25%" align="left">Update Kain</td>
			...
			<?
				$sql="select id_tipe_baju id_tipe_kain,keterangan from p_baju_tipe where upper(keterangan) like '%KAIN%' order by keterangan asc";
				$rs=mysql_query($sql);
				for($a=0;$a<mysql_num_rows($rs);$a++){
				echo "<option ";
			...
			<?
				...
				$sql="select id_layanan,layanan from p_baju where id_tipe_baju='$id_tipe_kain'";
				$rs=mysql_query($sql);
				for($a=0;$a<mysql_num_rows($rs);$a++){
				echo "<option ";
				$idl=mysql_result($rs,$a,"id_layanan");
		...
		<tr><td width="25%" align="left">Update Blangkon</td>
			...
			<?
				$sql="select id_tipe_baju,keterangan from p_baju_tipe 
				where upper(keterangan) like '%BLANGKON%' order by keterangan asc";
				$rs=mysql_query($sql);
				for($a=0;$a<mysql_num_rows($rs);$a++){
				echo "<option ";
				$idp=mysql_result($rs,$a,"id_tipe_baju");
		...
		<tr><td width="25%" align="left">Update Selop</td>
			...
			<?
				...
				$sql="select id_layanan, layanan from p_sepatu where id_tipe_sepatu='$id_tipe_sepatu'";
				$rs=mysql_query($sql);
				for($a=0;$a<mysql_num_rows($rs);$a++){
				echo "<option ";
				$idl=mysql_result($rs,$a,"id_layanan");
