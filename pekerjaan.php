...
if($act=="delete"){
mysql_query("delete from p_pekerjaan where id_pekerjaan='$id'");
$act=null;
}
...
$runSQL = "select count(*) total from p_pekerjaan where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select * from p_pekerjaan where 1=1 $filterSQL order by id_pekerjaan LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
while ($row = mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=pekerjaan_input&id=$row[id_pekerjaan]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  <a href='?menu=$menu&uid=$uid&page=pekerjaan&act=delete&id=$row[id_pekerjaan]'><img border='0' src='images/del.gif' title='Hapus Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Pekerjaan</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=pekerjaan";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=pekerjaan_input";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
	 ...
	 <table width='700' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			...
			<td align='center'>CODEJOB</td>
			<td align='center'>URAIAN TUGAS</td>
