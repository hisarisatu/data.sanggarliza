...
$htmlData .= "$row[jml] <a href='?menu=$menu&uid=$uid&page=assign_petugas&id_client=$row[id_client]&id_acara=$row[id_acara]&id_layanan=$row[id_layanan]'><img border='0' src='images/res.gif' height=16 width=16 title='Petugas'></a></td>";
/*
if($SAH[id_group]==1){
$htmlData .= "
...
<? $act=null; } ?>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=penjadwalan";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=penjadwalan&act=cari";?>">Cari</a></b>
		 </td>
		 </form>
	  </tr>
	 </table>
