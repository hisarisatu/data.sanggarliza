...
$runSQL = "	select b.id_pengeluaran,a.id_client,date_format(b.tanggal,'%d-%m-%Y') tgl_keluar,c.keterangan,
...
and b.id_penerima=d.id_penerima $filterSQL
union
select b.id_pengeluaran,null,b.tanggal tgl_keluar,c.keterangan,
...
?>
<td> </td>
<td colspan=5 align=center><b> -------- T O T A L  P E N G E L U A R A N --------</b></td>
