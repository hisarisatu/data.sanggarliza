...
$result1 = mysql_query($runSQL1, $connDB);
for($n2=0;$n2<mysql_num_rows($result1);$n2++){
$www++;

echo "<font color='#FF0000'> <table width = 800 border =0>";
echo "<tr>";
echo "<td width='50' <font color='#000000'>";
echo "&nbsp; &nbsp; ".($offsetRecord+$www)." . </font> </td>";
echo "<td width='136' > <font color='#000000'>";
echo mysql_result($result1,n2,"tanggal"); 
echo "</font> </td>";
echo "<td width='277' > <font color='#000000'>";
echo mysql_result($result1,n2,"isi");  
echo "</font> </td>";
echo "<tr>";
echo "</table>";
echo "</font>"; 
...
$result1 = mysql_query($runSQL1, $connDB);
for($n3=0;$n3<mysql_num_rows($result1);$n3++){
$www++;
...
echo "&nbsp; &nbsp; ".($offsetRecord+$www)." . </font> </td>";
echo "<td width='136' > <font color='#000000'>";
echo mysql_result($result1,n3,"tanggal"); 
echo "</font> </td>";
echo "<td width='277' > <font color='#000000'>";
echo mysql_result($result1,n3,"isi");  
echo "</font> </td>";
echo "<tr>";
echo "</table>";
echo "</font>"; 
