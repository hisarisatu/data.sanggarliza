...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <a href="cetak_report_wanita5.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
...
<table width = 850 border="0" cellpadding="3" cellspacing="0">
	  <tr >
     <td width="50%" valign="bottom" align="left"> &nbsp; 
	     <font class="titledata" color="#009900"><b>Rincian Ukuran Kebaya</b></font>
		 </td>
     <td width="50%" valign="bottom" align="right">
...
$np=mysql_query("select baju, ukuran_kebaya, COUNT(ukuran_kebaya) as jml_baju
				
				from  v_wanita_ukuran
				
				where id_client='$id_client' and id_baju='$id_baju' and id_acara='$id_acara' and   	id_sublayanan='$id_plus' group by ukuran_kebaya");
