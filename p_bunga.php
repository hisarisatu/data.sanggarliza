...
$runSQL = "select count(*) total from bunga_paket  order by nama_paket asc   $filterSQL";
...
unset($ii);
$runSQL = "select id_paket, nama_paket, uraian_paket, tgl_inisial, tgl_expire, id_user, login_ip, created, user_update, ip_update, last_update from bunga_paket $filterSQL order by id_paket desc LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
...
$sql="select detail_layanan from bunga_detail where id_bunga in (select id_bunga from bunga_sub_paket where id_paket='$row[id_paket]')";
//echo $sql;//developer
$rs=mysql_query($sql);
$n=mysql_num_rows($rs);
...
if($n>3)$htmlData .= "&raquo;........";
        ...
        $htmlData .= " </td>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=p_bunga_input&id=$row[id_paket]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  <a href='?menu=$menu&uid=$uid&page=p_bunga_view&id=$row[id_paket]'><img border='0' src='images/view.png' title='Lihat Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Paket Bunga</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_bunga";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_bunga_input";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
