...
<a href="javascript:void(window.open('print_no_tas_pria.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
echo "</td><td><b>Baju</b>";
echo "</td><td ><b>Kain</b>";
echo "</td><td align='center'width='3%'><b>No Tas</b>";
echo "</td><td align='center' width='10%'> <b>Ambil </b>";

echo "</td><td align='center' width='10%'><b>Kembali</b>";
echo "</td><td align='center' width='10%'><b>Keterangan</b>";
//echo "</td><td > <b>Jml</b>";
...
$np=mysql_query("select j.nama, k.nama_jabatan, b.layanan as baju, d.layanan as sepatu, f.layanan as kain, l.nama_ukuran_baju as u_baju, m.nama_ukuran_baju as u_sepatu, n.nama_ukuran_baju as u_blangkon 
				...
				where  b.id_layanan='$id_baju' and d.id_layanan='$id_sepatu' and f.id_layanan='$id_kain' and c.id_client='$id_client' and c.id_acara='$id_acara' and j.id_acara=c.id_acara and c.id_client=j.id_client and j.id_jabatan=k.id_jabatan and j.ukuran_beskap=l.id_ukuran_baju and j.ukuran_selop=m.id_ukuran_baju and j.ukuran_blangkon=n.id_ukuran_baju 
