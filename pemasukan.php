...
<br>
<form method=post action="?menu=<?=$menu?>&uid=<?=$uid?>&page=pemasukan&act=input_pengeluaran">
<table>
<tr>
...
<select name="kota" id="kota" >
     ...
     <?php
$kota1 = mysql_query("SELECT * FROM p_noakun where kategori = '2' ORDER BY id_noakun");
while($p=mysql_fetch_array($propinsi1)){
...
if($inputdata)
{
		...
		$sql="insert into pemasukan (id_pemasukan, tanggal, id_acara, id_client, id_jenis_bagian, detail, jumlah, no_nota, id_noakun)
		values(null,'$tanggal3','$id_acara','$id_client','$propinsi','$detail','$jumlah','$no_nota','$kota')";
