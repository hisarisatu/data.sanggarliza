...
if ($cari <> ""){ 
	...
	$filterSQL = " and upper(pekerjaan) like upper('%$cariSQL%') ";
};//if

if($id_tipe_baju!=""){
	$filterSQL .= " and a.id_produk like '$id_produk' ";
}

$runSQL = "select count(*) total from p_pekerjaan a where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select a.id_produk,produk,a.id_pekerjaan,a.pekerjaan,a.uraian_pekerjaan 
 from p_pekerjaan a, p_produk b 
where b.id_produk=a.id_produk $filterSQL 
order by a.id_produk,a.id_pekerjaan 
...
while ($row = @mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		...
		<a href='?menu=$menu&uid=$uid&page=p_pekerjaan_add&id=$row[id_pekerjaan]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		</td>
	  </tr>
	";//htmlData
};//end-while
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_pekerjaan";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_pekerjaan_add";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
	 ...
	 <table width='700' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			<td align='center'>NO</td>
						...
						<td align='center'>Uraian Pekerjaan</td>
