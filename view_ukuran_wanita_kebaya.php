...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <a href="cetak_report_wanita4.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
<a href="javascript:void(window.open('print_backroom_kebaya.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
<table width = 850 border="0" cellpadding="3" cellspacing="0">
	  <tr >
     <td width="50%" valign="bottom" align="left"> &nbsp; 
	     <font class="titledata" color="#009900"><b>Rincian Rekap Ukuran Kebaya</b></font>
		 </td>
     <td width="50%" valign="bottom" align="right">
...
echo "</td><td align='center'><b>Ukuran Kebaya</b>";
...
//$np=mysql_query("select j.id_client, j.id_acara, j.id_paket, j.id_sublayanan, j.id_jabatan, j.nama, k.nama_jabatan, b.layanan as baju,  f.layanan as kain, e.layanan as acc, d.layanan as sepatu, j.id_sanggul, j.jenis_rias, j.pakai_kain, j.pakai_kebaya, j.pakai_acc, c.id_baju, c.id_kain, c.id_acc, c.id_sepatu,o.nama_ukuran_baju as ukuran_kebayafrom  p_baju b, client_busana c, v_kain f, daftar_ukuran_wanita j, p_jabatan k, p_acc e, p_sepatu d, p_jenis_ukuran_baju o where  b.id_layanan='$id_baju' and f.id_layanan='$id_kain' and j.id_client='$id_client' and j.id_acara='$id_acara' and j.id_client=c.id_client and j.id_acara=c.id_acara and j.id_jabatan=k.id_jabatan and j.ukuran_kebaya=o.id_ukuran_baju and	j.id_sublayanan='$id_plus' group by j.nama");
	
$np=mysql_query("select nama, nama_jabatan, baju, ukuran_kebaya from v_wanita_ukuran where id_client='$id_client' and id_acara='$id_acara' and id_sublayanan='$id_plus' group by nama");
