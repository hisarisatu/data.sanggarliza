...
unset($ii);
/*
$runSQL = "SELECT distinct date_format(a.tanggal,'%d-%m-%Y') tgl_acara, b.acara, c.nama_cpw, c.nama_cpp, a.alamat_cpw,c.tlp_mobile_cpw,date_format(c.tgl_rencana,'%d-%m-%Y') tgl_rencana, a.tempat,a.id_client,a.id_acara
...
$totalRecord=0;
	 ...
	 <table width='100%' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			...
			<td align='center'>Lihat<br>Pesanan</td>
