...
(SELECT a.nama_cpw, a.nama_cpp, IFNULL(d.layanan,'-')layanan, b.detail_layanan, b.jml_orang, b.harga, b.satuan, c.nama, c.id_pegawai 
from client a
inner join pesanan_bebas b on b.id_client=a.id_client 
left join pegawai c on a.id_pegawai=c.id_pegawai 
left join p_layanan d ON b.id_sublayanan=d.id_layanan
...
$runSQL = "	SELECT a.nama_cpw, a.nama_cpp, IFNULL(d.layanan,'-')layanan, b.detail_layanan, b.jml_orang, b.harga, b.satuan, c.nama, c.id_pegawai 
from client a
inner join pesanan_bebas b on b.id_client=a.id_client 
left join pegawai c on a.id_pegawai=c.id_pegawai 
left join p_layanan d ON b.id_sublayanan=d.id_layanan
...
<tr bgcolor='#A7A7A7' height="25" align="center">
	<td width="59" >No</td>
	<td width="107" >Nama CPW</td>
	
	<td width="178" >Nama Petugas CS</td>
    <td width="381" >Group Layanan</td>
