...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <a href="cetak_report_wanita2.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
<a href="javascript:void(window.open('print_backroom_wanita_spesial.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
<table width = 850 border="0" cellpadding="3" cellspacing="0">
	  <tr >
     <td  width="50%" valign="bottom" align="left"> &nbsp; 
	     <font class="titledata" color="#009900"><b>Rincian Makeup Sepeial</b></font>
		 </td>
     <td width="50%" valign="bottom" align="right">
...
echo "</td><td width='15%' align='center' ><b>Ritouch</b>";
...
$np=mysql_query("select a.nama,  a.nama_jabatan, b.model_sanggul
				...
				where a.id_client='$id_client' and  a.id_acara='$id_acara' and  a.id_sublayanan='$id_plus' and a.jenis_rias=2 and a.id_sanggul=b.id_sanggul order by nama_jabatan");
