...
echo "</td><td  width='15%' align='center'><b></b>";
...
$np=mysql_query("select nama,  nama_jabatan
				
				from  v_wanita
				
				where id_client='$id_client' and  id_acara='$id_acara' and  id_sublayanan='$id_plus' and jenis_rias=2 order by nama_jabatan");
