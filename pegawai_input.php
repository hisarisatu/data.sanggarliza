...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_pegawai, nama, tlp_rumah, tlp_mobile, alamat, gaji_dasar, transport, uang_makan, catatan, atm, id_status from pegawai where id_pegawai='$id' ";
...
if (strlen($run) > 1){ 
	...
	if (($ok == 1) and ($id == "")){
		$registerInvalid = 1;
		$runSQL = "insert into pegawai VALUES (null,'$nama', '$tlp_rumah', '$tlp_mobile', '$alamat', '$id_status', '$gaji_dasar', '$transport', '$uang_makan', '$catatan', '$SAH[id_user]', '$REMOTE_ADDR', now(), '$SAH[id_user]', '$REMOTE_ADDR', now(), '$atm', '$bank')";
		//echo $runSQL;
		...
		$registerInvalid = 1;
		$runSQL = "update pegawai set nama='$nama', tlp_rumah='$tlp_rumah', tlp_mobile='$tlp_mobile', alamat='$alamat', id_status='$id_status', gaji_dasar='$gaji_dasar', transport='$transport', uang_makan='$uang_makan', catatan='$catatan', atm='$atm', bank='$bank', user_update='$SAH[id_user]', ip_update='$REMOTE_ADDR', last_update=now() where id_pegawai='$id'";
		//echo $runSQL;
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
		...
		<tr>
         ...
         <tr>
			...
			<td width="65%"><input type="text" name="bank" size="55" value="<?=htmlentities(stripslashes($bank));?>"></td>
		</tr>
        <tr>
			<td width="35%" align="right">No Rekening</td>
			<td width="65%"><input type="text" name="atm" size="55" value="<?=htmlentities(stripslashes($atm));?>"></td>
		</tr>
		<tr>
...
//registerInvalid
	...
	$runSQL = "select a.id_pegawai, nama, tlp_rumah, tlp_mobile, alamat, gaji_dasar, transport, uang_makan, catatan, atm, bank, status, id_user, login_ip, created, user_update, ip_update, last_update from pegawai a, p_pegawai_status b where a.id_pegawai='$id' and a.id_status=b.id_status";
     ...
     <td width="50%" valign="top" align="center">
		 <table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
             ...
             <tr>
				<td width="35%" align="right">Bank :</td>
				<td width="65%"><font class="datafield"><?=$bank;?></font></td>
			</tr>
            <tr>
				<td width="35%" align="right">No Rekening :</td>
				<td width="65%"><font class="datafield"><?=$atm;?></font></td>
			</tr>
		 </table>
		 </td>
     <td width="50%" valign="top" align="center">
