...
$runSQL = "select count(*) total from p_baju_tipe where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select id_tipe_baju,keterangan,harga from p_baju_tipe $filterSQL order by id_tipe_baju LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
while ($row = mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=p_baju_tipe_add&id=$row[id_tipe_baju]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Tipe Baju</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_baju_tipe";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_baju_tipe_add";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
