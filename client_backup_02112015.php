...
$runSQL = "select count(*) total from (SELECT distinct a.id_client, a.nama_cpw, a.nama_ortu_cpw, a.tlp_rumah_cpw, a.tlp_mobile_cpw, a.alamat_cpw, a.nama_cpp, a.nama_ortu_cpp, a.tlp_rumah_cpp, a.tlp_mobile_cpp, a.alamat_cpp, a.tgl_rencana, a.catatan, a.last_update,  b.nama
FROM client a, pegawai b
WHERE a.id_pegawai = b.id_pegawai $filterSQL) b";
