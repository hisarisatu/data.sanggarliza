...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_client, nama_cpw, nama_ortu_cpw, tlp_rumah_cpw, tlp_mobile_cpw, alamat_cpw, nama_cpp, nama_ortu_cpp, tlp_rumah_cpp, tlp_mobile_cpp, alamat_cpp, tgl_rencana, catatan,email,facebook,twiter,id_pegawai,status,ptp,no_rek from client where id_client='$id'";
...
if (strlen($run) > 1){ 
	...
	$ok = 1;
	if (strlen($nama_cpw) < 1){ $inama_cpw = "<br><font color='#FF0000' size='1'><i>* Nama CPW tidak valid"; $ok=0; }
   ...
   <td width="100%" align="center" vAlign="top">
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
		...
		<tr>
			...
			<td width="65%"><input type="text" name="nama_cpw" size="40" value="<?=htmlentities(stripslashes($nama_cpw));?>" required> <font color="#FF0000"><b>*</b></font> <?=$inama_cpw;?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="65%"><input type="text" name="tlp_mobile_cpw" size="20" value="<?=htmlentities(stripslashes($tlp_mobile_cpw));?>" required> <font color="#FF0000"><b>*</b></font> <?=$itlp_mobile_cpw;?></td>
		</tr>
		<tr>
			<td width="35%" align="right">Alamat CPW</td>
			<td width="65%"><input type="text" name="alamat_cpw" size="55" value="<?=htmlentities(stripslashes($alamat_cpw));?>" required> <font color="#FF0000"><b>*</b></font> <?=$ialamat_cpw;?></td>
		</tr>
		...
		<tr>
			<td width="35%" align="right">No Rekening</td>
			<td width="65%"><input type="text" name="no_rek" size="20" value="<?=htmlentities(stripslashes($no_rek));?>"> <font color="#FF0000"><b>*</b></font> <?=$ino_rek;?></td>
		</tr>
		<tr>
		...
		<tr>
		<tr>
			<td width="35%" align="right">Ptp</td>
			<td width="65%"><textarea name="ptp" rows="5" cols="60"><?=htmlentities(stripslashes($ptp));?></textarea></td>
		</tr>
		<tr>
...
//registerInvalid
	...
	$runSQL = "select id_client, nama_cpw, nama_ortu_cpw, tlp_rumah_cpw, tlp_mobile_cpw, alamat_cpw, nama_cpp, nama_ortu_cpp, tlp_rumah_cpp, tlp_mobile_cpp, alamat_cpp, tgl_rencana, catatan, id_user, login_ip, created, user_update, ip_update, last_update,email,facebook,twiter,id_pegawai,status,ptp,no_rek from client where id_client='$id'";
	$result = mysql_query($runSQL, $connDB);
	if ($row = mysql_fetch_array ($result)) {
		$id_client = $row[id_client];
		$nama_cpw = $row[nama_cpw];
   ...
   <td width="100%" align="center" vAlign="top">
     ...
     <td width="50%" valign="top" align="center">
		 <table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td width="35%" align="right">No Rekening :</td>
				<td width="65%"><font class="datafield"><?=$no_rek;?></font></td>
			</tr>
			<tr>
				<td width="35%" align="right">Email CPW/CPP :</td>
		...
		<tr>
			...
			<tr>
				<td width="35%" align="right">PTP :</td>
				<td width="65%"><font style="text-transform:uppercase;"><?=$ptp;?></font></td>
			</tr>
		 </table>
		 </td>
     <td width="50%" valign="top" align="center">
