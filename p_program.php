...
if ($cari <> ""){ 
	...
	$filterSQL = " and upper(nama_program) like upper('%$cariSQL%') ";
};//if

$runSQL = "select count(*) total from tb_program where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select id_program,nama_program, kode  from tb_program $filterSQL order by id_program LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
while ($row = @mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=p_program_add&id=$row[id_program]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Program</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_program";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_program_plus";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
	 ...
	 <table width='700' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			...
			<td width="257" align='center'>KODE PROGRAM</td>
