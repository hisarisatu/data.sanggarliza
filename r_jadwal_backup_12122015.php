...
include_once("include.php");
$runSQL1 = "select a.pengumuman, b.nama from p_pengumuman a, pegawai b where b.id_pegawai=a.nama and (tgl_habis BETWEEN '$tanggal' AND '$tanggal2') group by nama order by id_pengumuman asc";
$result1 = mysql_query($runSQL1, $connDB);
while ($row1 = mysql_fetch_array ($result1))
{ 
$ccc++;

echo "<font color='#FF0000'> <table width = 400 border =0>
<tr>
