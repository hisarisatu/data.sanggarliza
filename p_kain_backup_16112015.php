...
$runSQL="select id_kain,keterangan,IFNULL(nama,'-')nama 
  from p_kain a 
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_kain";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_kain_add";?>">Tambah</a>| <a href="<?="?menu=$menu&uid=$uid&page=p_baju_tipe";?>">Tambah Katagori</a></b>
		 </td>
		 </form>
	  </tr>
