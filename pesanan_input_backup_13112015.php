...
if($act=="add_noextra_proses"){
	...
	{$sql="insert into pesanan_bebas(id_client,id_acara,detail_layanan,jml_orang,harga,satuan) values('$id_client','$id_acara','$layanan_bebas','$jml_layanan','$harga_bebas','$id_satuan')";
