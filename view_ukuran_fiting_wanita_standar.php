  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <td width="50%" valign="bottom" align="right">
      ...
      <a href="cetak_report_wanita3.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
