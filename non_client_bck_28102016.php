...
unset($ii);
$runSQL = "Select a.id_non_client,a.nama, ifnull(b.keterangan,'-')divisi, a.detail, DATE_FORMAT(a.tanggal, '%d-%m-%Y')tanggal, a.jumlah, ifnull(c.keterangan,'-')jenis_bayar
, ifnull(d.keterangan,'-')bank
from non_client a
left join p_pengeluaran b on a.divisi=b.id_jenis_bagian
left join p_pembayaran c on a.jenis_bayar=c.id_jenis_bayar
...
if($SAH[id_group]==1 or $SAH[id_group]==3 or $SAH[id_group]==5){
