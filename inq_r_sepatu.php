...
c.nama_cpw,c.nama_cpp CP,e.detail_layanan, i.layanan
...
c.nama_cpw,c.nama_cpp,e.detail_layanan,h.keterangan tipe_sepatu,g.jml_sepatu, i.layanan sepatu
...
?>
	...
	<td><?= $rec['tipe_sepatu'];?>/<?= $rec['sepatu'];?></td>
