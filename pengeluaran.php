...
if($inputdata)
{
		...
		$sql="insert into pengeluaran (id_pengeluaran, tanggal, id_acara, id_client, id_jenis_bagian, penerima, detail, jumlah, no_nota, id_noakun)
		values(null,'$tanggal3','$id_acara','$id_client','$propinsi','$p_penerima','$detail','$jumlah','$no_nota','$kota')";
