...
{$filterSQL .= " and tgl_rencana BETWEEN '$tanggal' AND '$tanggal2'";}  
 ...
 $pageFilter ="&tanggal=$tanggal&tanggal2=$tanggal2&id_client=$id_client&nama_cpw=$nama_cpw&id_pegawai=$id_pegawai";
...
where 1=1 and id_client in (select distinct id_client from acara) $filterSQL)b";
//echo $runSQL;
...
unset($ii);
$runSQL = "SELECT distinct a.id_client, a.nama_cpw, a.nama_ortu_cpw, a.tlp_rumah_cpw, a.tlp_mobile_cpw, a.alamat_cpw, a.nama_cpp, a.nama_ortu_cpp, a.tlp_rumah_cpp, a.tlp_mobile_cpp, a.alamat_cpp,DATE_FORMAT(tgl_rencana, '%d-%m-%Y')tgl_rencana, a.catatan, a.last_update,ifnull(a.id_pegawai,'-')id_pegawai, ifnull(b.nama,'-')nama
FROM client a
left join pegawai b on a.id_pegawai = b.id_pegawai 
...
$htmlData .= "<td><a href='?menu=$menu&uid=$uid&page=retur_perias_input&id_client=$row[id_client]'><img border='0' src='images/add.gif' title='Input Returan' qidth=16 height=16></a>";
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   ...
   <font class="titledata"><b>Data Pesanan Perias</b></font>
 ...
 <input type='text' name='tanggal' id="tanggal" size='11' value='<?=$tanggal?>'>
    ...
    <input type='text' name='tanggal2' id="tanggal2" size='11' value='<?=$tanggal2?>'>
       ...
       <b> &nbsp; <input type="text" name="nama_cpw" value="<?=$nama_cpw;?>" size="10" placeholder="Nama CPW"> <input type="text" name="id_client" value="<?=$id_client;?>" size="10" placeholder="ID Client">
                <b> &nbsp; Petugas CS : 
<?
js_submit();
...
?>
   ...
   <table width='100%' cellspacing='1' cellpadding='3'>
    ...
    <tr bgcolor='#A7A7A7' height="25">
      ...
      <td align='center'>Input<br>Returan</td>
