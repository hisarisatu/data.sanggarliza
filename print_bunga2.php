...
for($n1=0;$n1<mysql_num_rows($res);$n1++){
 ...
 $rp=mysql_query("select id_paket from bunga_acara where id_client='$id_client'");
//$no=0;
...
echo $no.". ";
		...
		$sql="SELECT DISTINCT a.id_bunga, a.detail_layanan
FROM bunga_detail a, bunga_sub_paket b, bunga_acara c
WHERE c.id_client ='$id_client'
AND a.id_bunga = b.id_bunga
AND b.id_paket = c.id_paket
ORDER BY a.id_bunga";//echo $sql;
		$rs=mysql_query($sql);
		$n=mysql_num_rows($rs);
...
$sql="
select DISTINCT detail_layanan,id_bebas from
bunga_bebas a
