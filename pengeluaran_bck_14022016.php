...
<tr>
	<td><b>No Akun</b></td>
	<td><b>:</b></td> 
	<td><input type="text" name="no_akun" value=<?=$no_akun?>></td>
</tr>
...
if($inputdata)
{
		...
		{    
		$sql="insert into pengeluaran (id_pengeluaran, tanggal, id_acara, id_client, id_jenis, penerima, detail, jumlah, no_nota, no_akun)
		values(null,'$tanggal3','$id_acara','$id_client','$id_jenis_pengeluaran','$p_penerima','$detail','$jumlah','$no_nota','$no_akun')";
		}
