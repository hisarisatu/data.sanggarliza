		...
		<tr>
			...
			switch($id_layanan){
				case 2:
					...
					<td><?="<a href=\"javascript:void(window.open('assign_baju.php?id_client=$id_client&id_acara=$id_acara&id_paket=$id_paket&id_plus=$id_sublayanan','operator','toolbar=0,width=500,height=200'));\"><img src='images/arw.gif' border=0 title='Pilih Kain'></a>"?></td>
					<?
				break;
			}
			?>
