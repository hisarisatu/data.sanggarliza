...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_tugas, nama, detail, tanggal, progres from tugas where id_tugas='$id'";
...
//if (strlen($id_pegawai) < 1){ $iid_pegawai = "<br><font color='#FF0000' size='1'><i>* Petugas CS tidak valid"; $ok=0; }
		...
		if (($ok == 1) and ($id == "")){
		$runSQL = "insert into tugas (nama, detail, tanggal, progres, created) VALUES ('$nama', '$detail', '$new_tanggal', '$progres', now())";
		//echo $runSQL;
		$insert = mysql_query($runSQL, $connDB);
		$id = mysql_insert_id($connDB);
	} else if (($ok == 1) and ($id <> "")){
		$registerInvalid = 1;
		$runSQL = "update tugas set progres='$progres' where id_tugas='$id'";
		//echo $runSQL;
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Data Tugas Pegawai</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <a href="<?="?menu=$menu&uid=$uid&page=tugas";?>"><b>Back Data Tugas Pegawai</b></a>
		 </td>
	  </tr>
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" width="650">
		...
		<tr>
			<td width="100%" align="right">Nama Pegawai</td>
			<td width="65%"><input type="text" name="nama" size="40" value="<?=$nama;?>" disabled > <font color="#FF0000"><b>*</b></font> <?=$inama;?></td>
		</tr>
		<tr>
			<td width="100%" align="right">Detail Tugas</td>
			<td width="65%"><textarea name="detail" cols="50" rows="5" disabled  ><?=$detail;?></textarea> <font color="#FF0000"><b>*</b></font> <?=$idetail;?></td>
		</tr>
				<tr>
			<td width="100%" align="right">Dateline</td><td> <input type='text' name='tanggal' size='11' value='<?=$new_tanggal?>'disabled >
			<script language='JavaScript'> new tcal ({'formname': 'form','controlname': 'tanggal'}); </script>
			</td>
			</tr>
            <tr>
			<td width="100%" align="right">Progres</td>
			<td width="65%"><input type="text" name="progres" size="7" value="<?=$progres;?>"> <font color="#000000"><b>%</b></font> <?=$iprogres;?></td>
		</tr>
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Input/Edit Tugas Pegawai</b><br></font>
     ...
     <td width="50%" valign="top" align="center">
		 <table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
			  <td colspan="2" align="center"> <b>Data  Tugas Pegawai</b> </td></tr>
			<tr>
				<td width="49%"  align="right">Nama  :</td>
				<td width="51%" ><font class="datafield"><?=$nama;?></font></td>
			</tr>
			<tr>
			  <td  align="right">Detail Tugas:</td>
			  <td ><font class="datafield"><?=$detail;?></font></td>
			  </tr>
			<tr>
			  <td  align="right">Dateline :</td>
			  <td ><font class="datafield"><?=$tanggal;?></font></td>
			  </tr>
              <tr>
			  <td  align="right">Progres :</td>
			  <td ><font class="datafield"><?=$progres;?></font></td>
			  </tr>
		 </table>
	 ...
	 <p>&nbsp;</p>
	 <img src="images/arrow2.gif" border="0">
	 <a href="<?="?menu=$menu&uid=$uid&page=tugas";?>"><b>Back Data Tugas Pegawai</b></a></td>
  </tr>
  </form>
</table>
<? };//registerInvalid 
