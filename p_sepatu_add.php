...
if ((strlen($run) < 1) and ($id <> "")){ 
	$runSQL = "select id_layanan, id_tipe_sepatu, layanan,warna from p_sepatu where id_layanan='$id'";
        //echo $runSQL;
...
if (strlen($run) > 1){ 
	...
	if (($ok == 1) and ($id == "")){
		$registerInvalid = 1;
		$runSQL = "insert into p_sepatu (id_tipe_sepatu,layanan,warna) VALUES ('$id_tipe_sepatu','$layanan', '$id_warna')";
		//echo $runSQL;
		$insert = mysql_query($runSQL, $connDB);
		$id = mysql_insert_id($connDB);
	} else if (($ok == 1) and ($id <> "")){
		$registerInvalid = 1;
		$runSQL = "update p_sepatu set id_tipe_sepatu='$id_tipe_sepatu',layanan='$layanan', warna='$id_warna' where id_layanan='$id'";
		//echo $runSQL;
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <img src="images/arrow2.gif" border="0">
			 <a href="<?="?menu=$menu&uid=$uid&page=p_sepatu_ukuran";?>"><b>Tambah Ukuran baju</b></a>
			 <img src="images/arrow2.gif" border="0">
