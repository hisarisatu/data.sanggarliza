...
<td><input type='text' name='tgl_bayar' id='tgl_bayar' size='11' value='<?=$tanggal;?>'>
...
set tanggal='$tgl_byr',nilai='$nilai',keterangan='$keterangan',pembayar='$pembayar',catatan='$catatan',
