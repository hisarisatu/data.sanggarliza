...
<a href="javascript:void(window.open('print_bunga3.php?id=<?=$id?>&id_acara=<?=$id_acara?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Pesanan Bunga'></a>
	     &nbsp; &nbsp; 
		 </td>
		</tr>
...
where a.id_acara='$id_acara' 
and b.id_acara=a.id_acara
