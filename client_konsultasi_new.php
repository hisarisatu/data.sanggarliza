...
<form method="post" action="<?="?menu=$menu&uid=$uid&page=client_konsultasi_new&act=proses&id_client=$id_client";?>">
<table>
...
$sql = "select tanggal tgl_konsul,id_konsultasi, isi,
...
<td><a href='?menu=$menu&uid=<?=$uid?>&page=client_konsultasi_new&id_client=<?=mysql_result($rk,$k,"id_client")?>
