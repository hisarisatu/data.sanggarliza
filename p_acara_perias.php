...
$runSQL = "select count(*) total from p_acara_rias where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select id_acara, acara from p_acara_rias where 1=1$filterSQL order by id_acara LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Acara Perias</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_acara_perias";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_acara_perias_add";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
