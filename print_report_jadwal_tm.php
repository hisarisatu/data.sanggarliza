...
<style>
    body {
        background-image: url(image/logo_liza2.jpg);
...
$runSQL = "select a.id_client, a.nama_cpw, a.tlp_mobile_cpw, a.nama_cpp, a.tlp_mobile_cpp, a.tgl_rencana, b.tgl_tm, b.waktu_tm, b.lokasi, b.petugas_tm, b.keterangan, ifnull(c.nama,'-')nama
 ...
 where a.id_client=b.id_client and b.tgl_tm BETWEEN '$tanggal' AND '$tanggal2'
...
?>
    ...
    <div align="center">
        <font size="5"><b>Laporan Jadwal TM Tgl <font color="red"><?=$tanggal?></font> s.d <font color="red"><?=$tanggal2?></font></b></font>
    </div>
    </br>
    </br>

    <body background="http://data.sanggarliza.com/images/logo_liza2.jpg">
        <font size="12">
...
?>
                    ...
                    <td align='center'>
                        <? echo $rec['tlp_mobile_cpw'];?>
                    </td>
                    <td align='center'>
                        <? echo $rec['nama_cpp']; ?>
                    </td>
                    <td align='center'>
                        <? echo $rec['tlp_mobile_cpp']; ?>
                    </td>
                    <td align='center'>
                        <? echo $rec['tgl_rencana']; ?>
                    </td>
                    <td align='center'>
                        <? echo $rec['tgl_tm']; ?>
                    </td>
