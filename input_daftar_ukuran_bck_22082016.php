...
<tr><td>Ukuran Blangkon </td><td>:	<?
			$sqlblangkon="select 65,'50' from dual 
...
when ukuran_celana =32 then 26
when ukuran_celana =33 then 27
when ukuran_celana =34 then 28
when ukuran_celana =35 then 29
when ukuran_celana =36 then 30
when ukuran_celana =37 then 31
when ukuran_celana =38 then 32
when ukuran_celana =39 then 33
when ukuran_celana =40 then 34
when ukuran_celana =41 then 35
when ukuran_celana =42 then 36
when ukuran_celana =43 then 37
when ukuran_celana =44 then 38
when ukuran_celana =45 then 39
when ukuran_celana =46 then 40
when ukuran_celana =47 then 41
when ukuran_celana =48 then 42
when ukuran_celana =49 then 43
when ukuran_celana =50 then 44
when ukuran_celana =51 then 45
when ukuran_celana =52 then 46
when ukuran_celana =53 then 47
when ukuran_celana =54 then 48
