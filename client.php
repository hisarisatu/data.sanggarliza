...
if ($cari <> ""){ 
  ...
  $filterSQL = " and upper(nama_cpw) like '%$cariSQL%' or upper(id_client) like '%$cariSQL%' or upper(nama_ortu_cpw) like '%$cariSQL%' or upper(tlp_rumah_cpw) like '%$cariSQL%' or upper(tlp_mobile_cpw) like '%$cariSQL%' or upper(alamat_cpw) like '%$cariSQL%' or upper(nama_cpp) like '%$cariSQL%' or upper(nama_ortu_cpp) like '%$cariSQL%' or upper(tlp_rumah_cpp) like '%$cariSQL%' or upper(tlp_mobile_cpp) like '%$cariSQL%' or upper(alamat_cpp) like '%$cariSQL%' or upper(id_pegawai) like '%$cariSQL%' ";
};//if
...
$pageFilter ="&tanggal=$tanggal&tanggal2=$tanggal2&thn_rencana=$thn_rencana&bulan_rencana=$bulan_rencana&id_client=$id_client&nama_cpw=$nama_cpw&id_pegawai=$id_pegawai";
...
$htmlData .= "<td align='center' nowrap>
       <a href=\"javascript:void(window.open('perias_pengantin.php?id=$row[id_client]','operator','toolbar=0,width=900,height=200,top=0, left=60'));\"><img border='0' src='images/view.png'></a>";
$htmlData .= "<td align='center' nowrap>
  ...
  <tr>
   ...
   <table width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    <input type='text' name='tanggal2' id="tanggal2" size='11' value='<?=$tanggal2?>'>
       ...
       <b> &nbsp; <input type="text" name="nama_cpw" value="<?=$nama_cpw;?>" placeholder="Nama CPW" size="10"> &nbsp;  <input type="text" name="id_client" value="<?=$id_client;?>" placeholder="ID Client" size="10"> 
       <b> &nbsp; Petugas CS : 
<?
js_submit();
