...
$runSQL = "select count(*) total from p_ukuran_sepatu a where 1=1 $filterSQL";
 ...
 */
$runSQL="select a.id_layanan, a.layanan, b.id_layanan, b.tipe_ukuran_sepatu, b.id_tipe_sepatu, c.id_tipe_sepatu,
c.keterangan, d.nama_ukuran_baju, b.id_ukuran_sepatu, b.jumlah
from p_sepatu a, p_ukuran_sepatu b, p_sepatu_tipe c, p_jenis_ukuran_baju d
where b.id_layanan=a.id_layanan 
and b.id_tipe_sepatu=c.id_tipe_sepatu 
and b.tipe_ukuran_sepatu=d.id_ukuran_baju
and 1=1 $filterSQL
  
order by b.id_ukuran_sepatu desc LIMIT $offsetRecord, $listRecord";
...
<table  border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data List Ukuran Sepatu</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_sepatu";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_sepatu_ukuran";?>">Tambah Ukuran Baju</a>
		 </td>
		 </form>
	  </tr>
	 ...
	 <table width='728' cellspacing='1' cellpadding='3'>
		...
		<tr bgcolor='#A7A7A7' height="25">
			<td width="55" align='center'>NO</td>
                        ...
                        <td width="122" align='center'>Tipe Ukuran Sepatu</td>
