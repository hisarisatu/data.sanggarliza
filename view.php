  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <td width="50%" valign="bottom" align="left"> &nbsp; 
	     <font class="titledata" color="#009900"><b>Data Client : <span style="color:black;"> <?=$id_client;?> </span></b></font>
		 </td>
...
<a href="javascript:void(window.open('print.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
     ...
     <td width="50%" valign="top" align="center">
		 <table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td width="35%" align="right"><font style="font-size:13px;"><b>PTP </b>(Promise To Pay) <b>:</b></font></td>
				<td width="65%"><font style="text-transform:uppercase;color:red;font-size:14px;"><b><?=$ptp;?></b></font></td>
			</tr>
		 </table>
		 </td>
     <td width="50%" valign="top" align="center">
		 <table border="0" cellpadding="5" cellspacing="0" width="100%">
			...
			<tr>
				<td width="35%" align="right" style="color:green;"><b>No Rekening</b> :</td>
