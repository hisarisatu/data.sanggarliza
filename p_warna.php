...
if ($cari <> ""){ 
	...
	$filterSQL = " and upper(nama_warna) like upper('%$cariSQL%') ";
};//if

$runSQL = "select count(*) total from warna where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select id_warna,nama_warna from warna $filterSQL order by nama_warna asc LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
while ($row = @mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=p_warna_add&id=$row[id_warna]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Warna</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_satuan";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_warna_add";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
