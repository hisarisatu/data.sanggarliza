...
if (($SAH[id_group]==5) or ($SAH[id_group]==1))
{
		 ...
		 <script language="JavaScript" src="calendar_us.js"></script>
			...
			<tr bgcolor=<?=$color;?>>
				<td>
				 <table width='100%' border='0' cellpadding='2' cellspacing='0'>
					<tr>
					 <td> Layanan</td><td> : </td><td><?=$acara;?></td>
					</tr>
                                       <tr>
					 <td>Jumlah Orang</td><td> : </td><td><input type='text' name='catatan1' size='35' value='<?=$jml_layanan;?>'>
					 </td>
					</tr>
				 </table>
				</td>
...
}else{ echo "<div align='center'><font color='#FF0000'><b>Akses Tidak Diperbolehkan. Hanya Group Administrator dan Keuangan</b></font></div>"; }
?>