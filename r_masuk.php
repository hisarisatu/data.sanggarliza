...
<a href="print_r_masuk.php?tanggal=<?=$tanggal?>&tanggal2=<?=$tanggal2?>" target="_blank"><img border="0" src="images/Printer.png" height="25" width="25" alt="Print to Excel" title="Cetak pemasukan" /></a>
&nbsp;&nbsp;&nbsp;
<a href="print_r_masuk_12.php?tanggal=<?=$tanggal?>&tanggal2=<?=$tanggal2?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a>
