...
<a href="javascript:void(window.open('print_backroom_ukuran_kebaya.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
$np=mysql_query("select j.id_client, j.id_acara, j.id_paket, j.id_sublayanan, j.id_jabatan, j.nama, k.nama_jabatan, b.layanan as baju,  f.layanan as kain, e.layanan as acc, d.layanan as sepatu, j.id_sanggul, j.jenis_rias, j.pakai_kain, j.pakai_kebaya, j.pakai_acc, c.id_baju, c.id_kain, c.id_acc, c.id_sepatu
				,o.nama_ukuran_baju as ukuran_kebaya
				from  p_baju b, client_busana c, v_kain f, daftar_ukuran_wanita j, p_jabatan k, p_acc e, p_sepatu d, p_jenis_ukuran_baju o
				
				where  b.id_layanan='$id_baju' and f.id_layanan='$id_kain' and j.id_client='$id_client' and j.id_acara='$id_acara' and j.id_client=c.id_client and j.id_acara=c.id_acara and j.id_jabatan=k.id_jabatan 
	and j.ukuran_kebaya=o.id_ukuran_baju and	j.id_sublayanan='$id_plus' group by j.nama");
