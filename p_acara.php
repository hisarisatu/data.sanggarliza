...
if ($cari <> ""){ 
	...
	$filterSQL = " and upper(acara) like upper('%$cariSQL%') ";
};//if

$runSQL = "select count(*) total from p_acara where 1=1 $filterSQL";
...
unset($ii);
$runSQL = "select a.id_acara, a.acara, b.id_produk, b.produk from p_acara a, p_produk b where b.id_produk=a.id_produk $filterSQL order by id_produk LIMIT $offsetRecord, $listRecord";
//echo "$runSQL<br>";
$result = mysql_query($runSQL, $connDB);
while ($row = mysql_fetch_array ($result)) {
	...
	$htmlData .= "
	  <tr bgcolor='$color' onmouseover='bgColor=\"#FDD0D8\"' onmouseout='bgColor=\"$color\"'>
		  ...
		  <a href='?menu=$menu&uid=$uid&page=p_acara_add&id=$row[id_acara]'><img border='0' src='images/edit.gif' title='Edit Data'></a>
		  </td>
	  </tr>
	";//htmlData
};//end-while
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Acara</b></font>
     ...
     <td valign="bottom" align="right">
			 ...
			 <b><a href="<?="?menu=$menu&uid=$uid&page=p_acara";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=p_acara_add";?>">Tambah</a></b>
		 </td>
		 </form>
	  </tr>
