...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <a href="cetak_report_pria2.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
<a href="javascript:void(window.open('print_backroom_ukuran_pria_rekap.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
$np=mysql_query("select baju, u_baju, nama_jabatan, COUNT(u_baju) as jml_baju
...
$nl=mysql_query("select kain, nama_jabatan, COUNT(kain) as jml_kain
...
$nr=mysql_query("select blangkon, u_blangkon, nama_jabatan,  COUNT(u_blangkon) as jml_blangkon
...
$nh=mysql_query("select sepatu, u_sepatu, nama_jabatan,  COUNT(u_sepatu) as jml_sepatu
				
				from  v_ukuran_orang_pria
				
				where id_client='$id_client' and id_sepatu='$id_sepatu' and id_acara='$id_acara' and   	id_sublayanan='$id_plus' group by u_sepatu");
...
$nk=mysql_query("select acc, nama_jabatan,  COUNT(acc) as jml_acc
...
$nk=mysql_query("select celana, nama_jabatan,  COUNT(celana) as jml_celana
				
				from  v_ukuran_orang_pria
				
				where id_client='$id_client' and id_celana='$id_celana' and id_acara='$id_acara' and  id_sublayanan='$id_plus' group by celana");
