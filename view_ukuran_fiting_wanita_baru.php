...
<a href="cetak_report_wanita1.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
<a href="javascript:void(window.open('print_backroom_wanita_baru.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
echo "</td><td><b>Baju</b>";
echo "</td><td ><b>Kain</b>";
echo "</td><td ><b>Accesoris</b>";
echo "</td><td align='center'><b>No Tas</b>";
echo "</td><td align='center'> <b>Ambil </b>";

echo "</td><td align='center'><b>Kembali</b>";
...
$np=mysql_query("select nama, baju, kain, acc, nama_jabatan
				from v_wanita
				where id_client='$id_client' and id_acara='$id_acara' and id_baju='$id_baju' and id_acc='$id_acc' and id_kain ='$id_kain' and id_sublayanan='$id_plus'");
