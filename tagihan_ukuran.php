...
{$filterSQL .= " and tgl_rencana BETWEEN '$tanggal' AND '$tanggal2'";}	
 ...
 $pageFilter ="&tanggal=$tanggal&tanggal2=$tanggal2&nama_cpw=$nama_cpw&id_pegawai=$id_pegawai";
...
$htmlData .= "<td align='center' nowrap><a href='?menu=$menu&uid=$uid&page=view_tagihan_ukuran&id=$row[id_client]'><img border='0' src='images/view.png' title='Lihat Data'></a></td>
";
