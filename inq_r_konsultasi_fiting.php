...
if ($id_pegawai==0) {$id_pegawai='%';}
			...
			if($id_pegawai!="") $filterSQL .=" and b.petugas like '%$id_pegawai%' ";
...
(SELECT distinct a.nama_cpw, a.nama_cpp, max(b.tanggal) as tanggal, b.isi, c.nama, c.id_pegawai from client a, konsultasi_fiting b, pegawai c where b.id_client=a.id_client and b.petugas=c.id_pegawai $filterSQL group by b.id_client ) b ";
...
$runSQL = "	SELECT a.nama_cpw, a.nama_cpp, max(b.tanggal) as tanggal, b.isi, c.nama, c.id_pegawai from client a, konsultasi_fiting b, pegawai c where b.id_client=a.id_client and b.petugas=c.id_pegawai $filterSQL
group by b.id_client 
order by b.tanggal desc LIMIT $offsetRecord, $listRecord  ";
...
<table>
<tr>
	<td><b>Range Waktu Konsultasi</b></td>
	<td><b>:</b></td> 
	<td>   
...
<script type="text/javascript">//<![CDATA[
    ...
    //]]></script>
<div align="center"><font class="titledata"><b>Laporan Konsultasi </b></font></div>
...
<b><a href="<?= "?menu=5&uid=$uid&page=inq_r_konsultasi"; ?>">List All</a></b>
</div>
...
<tr bgcolor='#A7A7A7' height="25" align="center">
	<td width="59" >No</td>
	<td width="107" >Tanggal Konsultasi</td>
	
	<td width="178" >Nama Pengantin</td>
	<td width="381" >Isi</td>
	<td width="117" >Petugas CS</td>
