...
if ($cari <> ""){ 
	...
	$filterSQL = " and upper(nama_cpw) like '%$cariSQL%' or upper(alamat_cpw) like '%$cariSQL%' or upper(nama_cpp) like '%$cariSQL%' ";
};//if

if($act=="delete_acara"){
$sql="delete from pesan_bunga where id_client='$id'";
@mysql_query($sql);
$act=null;
}
...
$htmlData .= "<td align='center' nowrap><a href='?menu=$menu&uid=$uid&page=view_bunga&id=$row[id_client]'><img border='0' src='images/view.png' title='Lihat Data'></a></td><td align='center' nowrap>";
if($SAH[id_group]==1){
$htmlData .= "
		  <a href='?menu=$menu&uid=$uid&page=pesan_bunga&id=$row[id_client]&act=delete_acara'><img border='0' src='images/del.gif' title='Hapus Pesanan Bunga' qidth=16 height=16></a>
";
}
...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  <tr>
   <td width="100%" align="center" vAlign="top">
	 <font class="titledata"><b>Data Pesanan Bunga</b></font>
...
?>
			 ...
			 <? if($act=="cari"){?><b>Cari : <input type="text" name="cari" value="<?=$cari;?>" size="30"><? } ?>
			 <input type="submit" name="run" value="  Go  " class="button">
		 </td>
     <td valign="bottom" align="right">
			 <img src="images/arrow2.gif" border="0">
			 <b><a href="<?="?menu=$menu&uid=$uid&page=pesan_bunga";?>">List All</a> | <a href="<?="?menu=$menu&uid=$uid&page=pesan_bunga&act=cari";?>">Cari</a></b>
		 </td>
		 </form>
	  </tr>
	 </table>
