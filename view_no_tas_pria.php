...
<table border="0" width="850" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td width="100%" align="center" vAlign="top">
     ...
     <a href="cetak_report_pria1.php?&id=<?=$id_client?>" target="_blank"><img border="0" src="images/excel2007.jpg" height="25" width="25" alt="Print to Excel" title="Save to Excel" /></a> &nbsp;&nbsp;
<a href="javascript:void(window.open('print_backroom_ukuran_pria.php?id=<?=$id?>','','toolbar=no,menubar=no,scrollbars=yes,status=no'))"><img border=0 src='images/Printer.png' title='Cetak Rincian'></a>&nbsp;&nbsp;
...
//echo "</td><td><b>Baju</b>";
//echo "</td><td ><b>Kain</b>";
echo "</td><td  width='10%' align='center'><b>No Tas</b>";
echo "</td><td  width='15%' align='center'> <b>Ambil </b>";

echo "</td><td  width='15%'align='center'><b>Kembali</b>";
...
$np=mysql_query("SELECT distinct nama, nama_jabatan FROM v_ukuran_orang_pria where id_client='$id_client' and id_acara='$id_acara' and id_sublayanan='$id_plus'");

	//$np=mysql_query("select  b.layanan as baju, d.layanan as sepatu, e.layanan as acc, c.jml_baju, c.jml_kain, c.jml_sepatu, c.jml_acc, c.jml_blangkon from p_baju_tipe a, p_baju b, client_busana c, p_sepatu d, p_acc e where  b.id_layanan='$id_baju' and d.id_layanan='$id_sepatu");
